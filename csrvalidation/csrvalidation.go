...
// round trip.
//
// The rule sets mirror CsrValidationRules.kt in the registry
// (gdcorp-engineering/ans-registry-poc: SERVER_CSR_RSA_KEY_SIZES,
// IDENTITY_CSR_RSA_KEY_SIZES, IDENTITY_CSR_EC_CURVES and the signature
// allowlists, as of registry PR #1258). Change them together.
...
// ECDSA. EC acceptance follows the registry rollout of PR #1258; a registry
// without it still rejects EC identity CSRs at submission.
